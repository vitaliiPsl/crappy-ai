...
Crappy also keeps persistent memories about the user across sessions. It can save explicitly requested memories or useful durable facts. These structured memories are grouped as profile facts, preferences, or instructions and are stored in `~/.crappy-ai/memory.json` by default.
